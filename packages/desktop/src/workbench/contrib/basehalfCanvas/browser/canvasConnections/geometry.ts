...
import type { CanvasAnchor } from '../../../../services/mirror/common/canvas.js';

// The renderer's internal connection vocabulary stays React-Flow-native
// ('top'|'right'|'bottom'|'left'); the shared canvas protocol speaks compass
// anchors ('north'|'east'|'south'|'west'). This union is owned locally and
// translated to/from anchors only at the IPC boundary (see SIDE_TO_ANCHOR /
// ANCHOR_TO_SIDE below).
