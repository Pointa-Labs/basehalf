 ...
 * separate builder). The actions themselves go through the workspace service
 * boundary/store, with dialogs/inline-edit wired in.
 *
...
export async function confirmAndDelete(target: EntryTarget): Promise<void> {
