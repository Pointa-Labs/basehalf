...
import { BASEHALF_MODEL_SERVICES_SETTING } from './basehalfModelServices.js';
...
export function migrateLegacyBaseHalfModelServices(value: unknown): BaseHalfConfigurationMigrationValue {
