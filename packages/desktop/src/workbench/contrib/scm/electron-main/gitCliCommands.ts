...
import { assertBranchName, assertCount, assertSafeRef } from './gitRefGuards.js';
 ...
 * actions routed through the SCM UI. Path args are workspace-relative and
 * validated; git's own `--`/pathspec containment is the backstop.
 */
