...
import { BaseHalfAllowedExtensionsService } from './basehalf/common/basehalfAllowedExtensionsService.js';
...
registerSingleton(IAllowedExtensionsService, BaseHalfAllowedExtensionsService, InstantiationType.Delayed);
