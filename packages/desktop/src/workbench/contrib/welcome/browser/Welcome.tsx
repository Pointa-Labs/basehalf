 ...
 * store/actions directly, like every other top-level component. Workbench renders this
...
import { createDemoAtDefault } from '../../../browser/actions/workbenchActions.js';
...
import { selectWelcomeView } from './welcomeView.js';
