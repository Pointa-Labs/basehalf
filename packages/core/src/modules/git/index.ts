...
export function registerGitModule(core: Core): void {
  ...
  core.register('git.stashApply', git.stashApply);
  core.register('git.stashDrop', git.stashDrop);
  ...
  core.register('git.conflictStages', git.conflictStages);
  core.register('git.rebaseInteractive', git.rebaseInteractive);
