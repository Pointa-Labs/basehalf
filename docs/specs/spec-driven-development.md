...
points. They must carry the same current product rules, specification workflow,
decision index, and source-tree boundary. Product workspace setup must never
inject generated workspace-protocol instructions into either file.
